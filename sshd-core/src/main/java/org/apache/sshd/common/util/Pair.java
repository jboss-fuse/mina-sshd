...
public class Pair<F, S> implements Map.Entry<F, S> {
    ...
    private static final Comparator<Map.Entry<Comparable, ?>> BY_KEY_COMPARATOR = new Comparator<Map.Entry<Comparable, ?>>() {
        @Override
        public int compare(Map.Entry<Comparable, ?> o1, Map.Entry<Comparable, ?> o2) {
