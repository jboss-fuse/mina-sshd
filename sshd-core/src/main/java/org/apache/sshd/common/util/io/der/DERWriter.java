...
public class DERWriter extends FilterOutputStream {
    ...
    public void writeBigInteger(BigInteger value) throws IOException {
        ...
        writeBigInteger(value.toByteArray());
    }
    ...
    public void writeBigInteger(byte... bytes) throws IOException {
        writeBigInteger(bytes, 0, bytes == null ? 0 : bytes.length);
    }
    ...
    public void writeObject(ASN1Object obj) throws IOException {
        if (obj == null) {
            throw new NullPointerException("No ASN.1 object");
        }
    ...
    public void writeLength(int len) throws IOException {
        if (!(len >= 0)) {
            throw new IllegalArgumentException(String.format("Invalid length: %d", len));
        }
