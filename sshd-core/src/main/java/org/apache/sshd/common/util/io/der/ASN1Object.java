...
public class ASN1Object implements Serializable, Cloneable {
    ...
    public byte[] getPureValueBytes() {
        ...
        int numBytes = bytes == null ? 0 : bytes.length;
    ...
    public List<Integer> toOID() throws IOException {
        ...
        List<Integer> oid = new ArrayList<Integer>(vLen + 1);
        byte[] bytes = getValue();
    ...
    public int hashCode() {
        return Objects.hash(getObjClass(), getObjType())
             + (isConstructed() ? 1231 : 1237)
             + getLength()
             + hashCode(getValue(), 0, getLength());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.getObjClass(), other.getObjClass())
            ...
            && (diffOffset(this.getValue(), 0, other.getValue(), 0, this.getLength()) < 0);
    }
